...
namespace FreeSource.Modules.TabLocale.Components
{
    /// -----------------------------------------------------------------------------
    /// <summary>
    /// The Controller class for FreeSource_TabLocale
    /// 
    ...
    public class FeatureController : ModuleSearchBase, IPortable, IUpgradeable
    {
        ...
        {            
            ...
            //var controller = new TabLocaleController();
        ...
        public string ExportModule(int moduleId)
        {
            ...
            //var itemList = items as IList<TabLocale> ?? items.ToList();

            //if (!itemList.Any()) return string.Empty;

            //sb.Append("<Items>");

            //foreach (TabLocale item in itemList)
            //{
            //    sb.Append("<Item>");
